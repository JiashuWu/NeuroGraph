...
/**
 * Created by Jiashu Wu on 31/03/2018.
 */

public class outputCsvStringGenerator {
    ...
    public ArrayList<String> generate_string_from_database (Context context)
    {
        databaseHelper = new MyDatabaseHelper (context, databaseName, null, databaseVersion);
        databaseHelper.getReadableDatabase();

        output_string = new ArrayList<>();
        ...
        while (cursor.moveToNext())
        {
            ...
            output_string.add("test_id = " + String.valueOf(test_id) + "\n");
            output_string.add("user_id = " + String.valueOf(user_id) + "\n");
            output_string.add("test_starting_time = " + test_starting_time + "\n");
            output_string.add("test_ending_time = " + test_ending_time + "\n");
            output_string.add("test_type = " + test_type + "\n");
            output_string.add("image_type = " + image_type + "\n");
            output_string.add("interval duration = " + String.valueOf(interval_duration) + "\n");
            output_string.add("user name = " + name + "\n");
            output_string.add("age = " + String.valueOf(age) + "\n");
            output_string.add("gender = " + gender + "\n");
            output_string.add("education = " + education + "\n");
            output_string.add("rating score = " + String.valueOf(rating_score) + "\n");
            output_string.add("current receive treatment" + current_receive_treatment + "\n");
